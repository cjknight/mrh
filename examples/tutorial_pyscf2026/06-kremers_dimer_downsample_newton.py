...
mol = gto.M (atom=xyz, spin=6, charge=3, basis=basis,
             verbose=4, output='06-kremers_dimer_downsample_newton.log') 
mol.max_memory=8000
mf = scf.ROHF(mol)
mf.chkfile = '06-kremers_dimer_downsample_newton.chk'
mf.kernel () 
...
molden.from_mo (mol, '06-kremers_dimer_downsample_newton_guess.molden', mo_coeff, occ=mf.mo_occ)
...
# Use newton_casscf (i.e., full explicit CI response) algorithm
mc = mc.newton ()
mc.kernel (mo_coeff)
...
my_molden.from_mcscf (mc, '06-kremers_dimer_downsample_newton.molden', cas_natorb=True)
